...
public class Goods {
	...
	final String prefix = "goods_"; // what am i?
       ...
       static KafkaProducer<String, ViolationEvent> producerViolationEvents = null;	// new kafka producer for violation events
       ...
       {			
			...
			if (!v.equals(""))
			{
				...
				if (Simulate.kafkaViolationTopicOn)
				{
					...
					// now write ve to the violation topic
       ...
       // Note that as we have to actually get the Goods object being moved we have to do this for every Good already in the truck.
       // New version allows for Goods loaded and Goods on trucks to have rule violations
       ...
       // new version with String violation results, returns String null or ALL error messages.
